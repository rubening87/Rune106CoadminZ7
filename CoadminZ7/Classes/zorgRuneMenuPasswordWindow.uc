class zorgRuneMenuPasswordWindow extends UWindowFramedWindow;
...
function Created()
{
    ClientClass = Class'coadminz7.zorgRuneMenuPasswordCW';
    super.Created();
    ...
    CloseBox = none;
    UNK_v2948.NotifyWindow = zorgRuneMenuPasswordCW(ClientArea);
    UNK_v2948.Notify(0);
    UNK_v3202.SetText("Cancel");
    UNK_v2948.SetText("Connect");
    SetSizePos();
    bLeaveOnscreen = true;
    return;
}
...
function SetSizePos()
{
    SetSize(300.0000000, 120.0000000);
...
function BeforePaint(Canvas Parm_Canvas_0, float X, float Y)
{
    ...
    UNK_v2948.WinLeft = (ClientArea.WinLeft + ClientArea.WinWidth) - float(275);
    UNK_v2948.WinTop = (ClientArea.WinTop + ClientArea.WinHeight) + float(4);
    UNK_v3202.WinLeft = (ClientArea.WinLeft + ClientArea.WinWidth) - float(120);
